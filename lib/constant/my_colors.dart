...
class SolidColors {
  static const Color primeryColor = Color.fromARGB(255, 68, 8, 87);
  ...
  static const Color lifeText = Color.fromARGB(255, 255, 255, 255);
  ...
  static const Color submitPoscast = Color.fromARGB(255, 246, 246, 246);
  ...
  static const Color hintText = Color.fromARGB(255, 113, 113, 113);
}
...
class GradiantColors {
  ...
  static const List<Color> bolgPost = [
    Color.fromARGB(255, 0, 0, 0),
